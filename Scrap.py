...
#Main GUI Interface
label = tk.Label(text='ENTER WEBSITE LINK: ',font=('Arial 16 bold'),bg='#34495E',fg='white')
...
label1 = tk.Label(text='SHORTEST STORY IN DATASET:',font=('Arial 16 bold'),bg='#34495E',fg='white')
...
label2 = tk.Label(text='LONGEST STORY IN DATASET:',font=('Arial 16 bold'),bg='#34495E',fg='white')
...
label3 = tk.Label(text='TOP TEN WORDS BY FREQUENCY:',font=('Arial 16 bold'),bg='#34495E',fg='white')
...
label4 = tk.Label(text='TOTAL UNIQUE WORDS IN DATASET:',font=('Arial 16 bold'),bg='#34495E',fg='white')
...
label5 = tk.Label(text='TOTAL STORIES FOR EACH CATEGORY:',font=('Arial 16 bold'),bg='#34495E',fg='white')
...
label6 = tk.Label(text='PLOT BAR GRAPH FOR DATASET:',font=('Arial 16 bold'),bg='#34495E',fg='white')
